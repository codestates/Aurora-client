...
export const signupRequestAction = (data) => async (dispatch) => {
  try {
    const response = await axios.post('https://api.aurora.center/api/signup', data)
...
export const signupSuccessAction = (token) => async (dispatch) => {
  ...
  try {
    const response = await axios.post('https://api.aurora.center/api/activation', { activationToken: `${token}` })
...
export const getGoogleAuthURLAction = () => async (dispatch) => {
  const response = await axios.get('https://api.aurora.center/api/auth/google/url')
...
export const signinRequestAction = (data) => async (dispatch) => {
  try {
    const response = await axios.post('https://api.aurora.center/api/signin', data)
...
export const getAccessTokenAction = () => async (dispatch) => {
  try {
    const response = await axios.get('https://api.aurora.center/api/access-token')
...
export const signinSuccessAction = (token) => async (dispatch) => {
  try {
    const response = await axios.get('https://api.aurora.center/api/user', {
      headers: {
        Authorization: `${token}`
      }
    })
...
export const signoutAction = (token) => async (dispatch) => {
  try {
    const response = await axios.get('https://api.aurora.center/api/signout')
...
export const updateUerProfileAction = (data, token) => async (dispatch) => {
  const response = await axios.patch('https://api.aurora.center/api/user', data, {
    headers: {
      Authorization: `${token}`
    }
  })
...
export const withdrawal = (accessToken) => async (dispatch) => {
  try {
    ...
    const response = await axios.delete('https://api.aurora.center/api/user', { headers })
