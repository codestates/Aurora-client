...
export const signupRequestAction = (data) => async (dispatch) => {
  try {
    const response = await axios.post('https://ec2-54-180-89-122.ap-northeast-2.compute.amazonaws.com/api/signup', data)
...
export const signupSuccessAction = (token) => async (dispatch) => {
  ...
  try {
    const response = await axios.post('https://ec2-54-180-89-122.ap-northeast-2.compute.amazonaws.com/api/activation', { activationToken: `${token}` })
...
export const getGoogleAuthURLAction = () => async (dispatch) => {
  const response = await axios.get('https://ec2-54-180-89-122.ap-northeast-2.compute.amazonaws.com/api/auth/google/url')
...
export const signinRequestAction = (data) => async (dispatch) => {
  try {
    const response = await axios.post('https://ec2-54-180-89-122.ap-northeast-2.compute.amazonaws.com/api/signin', data)
...
export const getAccessTokenAction = () => async (dispatch) => {
  try {
    const response = await axios.get('https://ec2-54-180-89-122.ap-northeast-2.compute.amazonaws.com/api/access-token')
...
export const signinSuccessAction = (token) => async (dispatch) => {
  try {
    const response = await axios.get('https://ec2-54-180-89-122.ap-northeast-2.compute.amazonaws.com/api/user', {
      headers: {
        Authorization: `${token}`
      }
    })
...
export const signoutAction = (token) => async (dispatch) => {
  try {
    const response = await axios.get('https://ec2-54-180-89-122.ap-northeast-2.compute.amazonaws.com/api/signout')
...
export const updateUerProfileAction = (data, token) => async (dispatch) => {
  const response = await axios.patch('https://ec2-54-180-89-122.ap-northeast-2.compute.amazonaws.com/api/user', data, {
    headers: {
      Authorization: `${token}`
    }
  })
...
export const withdrawal = (accessToken) => async (dispatch) => {
  try {
    ...
    const response = await axios.delete('https://ec2-54-180-89-122.ap-northeast-2.compute.amazonaws.com/api/user', { headers })
