...
export const signupRequestAction = (data) => async (dispatch) => {
  try {
    const response = await axios.post('http://ec2-52-78-155-108.ap-northeast-2.compute.amazonaws.com:5000/api/signup', data)
...
export const signupSuccessAction = (token) => async (dispatch) => {
  ...
  try {
    const response = await axios.post('http://ec2-52-78-155-108.ap-northeast-2.compute.amazonaws.com:5000/api/activation', { activationToken: `${token}` })
...
export const getGoogleAuthURLAction = () => async (dispatch) => {
  const response = await axios.get('http://ec2-52-78-155-108.ap-northeast-2.compute.amazonaws.com:5000/api/auth/google/url')
...
export const signinRequestAction = (data) => async (dispatch) => {
  try {
    const response = await axios.post('http://ec2-52-78-155-108.ap-northeast-2.compute.amazonaws.com:5000/api/signin', data)
...
export const getAccessTokenAction = () => async (dispatch) => {
  try {
    const response = await axios.get('http://ec2-52-78-155-108.ap-northeast-2.compute.amazonaws.com:5000/api/access-token')
...
export const signinSuccessAction = (token) => async (dispatch) => {
  try {
    const response = await axios.get('http://ec2-52-78-155-108.ap-northeast-2.compute.amazonaws.com:5000/api/user', {
      headers: {
        Authorization: `${token}`
      }
    })
...
export const signoutAction = (token) => async (dispatch) => {
  try {
    const response = await axios.get('http://ec2-52-78-155-108.ap-northeast-2.compute.amazonaws.com:5000/api/signout')
...
export const updateUerProfileAction = (data, token) => async (dispatch) => {
  const response = await axios.patch('http://ec2-52-78-155-108.ap-northeast-2.compute.amazonaws.com:5000/api/user', data, {
    headers: {
      Authorization: `${token}`
    }
  })
...
export const withdrawal = (accessToken) => async (dispatch) => {
  try {
    ...
    const response = await axios.delete('http://ec2-52-78-155-108.ap-northeast-2.compute.amazonaws.com:5000/api/user', { headers })
