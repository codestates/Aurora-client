...
export const firstLoadAllPost = (time, accessToken) => async (dispatch) => {
  try {
    ...
    const response = await axios.get(`https://api.aurora.center/api/posts/all?page=${1}&createdAt=${time}`, { headers })
    dispatch({
...
export const moreLoadAllPost = (page, time, accessToken) => async (dispatch) => {
  try {
    ...
    const response = await axios.get(`https://api.aurora.center/api/posts/all?page=${page}&createdAt=${time}`, { headers })
    dispatch({
...
export const firstLoadPost = (accessToken) => async (dispatch) => {
  try {
    ...
    const response = await axios.get(`https://api.aurora.center/api/posts?page=${1}`, { headers })
    dispatch({
...
export const moreLoadPost = (page, accessToken) => async (dispatch) => {
  try {
    ...
    const response = await axios.get(`https://api.aurora.center/api/posts?page=${page}`, { headers })
    dispatch({
...
export const addPost = (data, accessToken) => async (dispatch) => {
  try {
    ...
    const response = await axios.post('https://api.aurora.center/api/post/', data, { headers })
    dispatch({
...
export const updatePost = (id, data, accessToken) => async (dispatch) => {
  try {
    ...
    const response = await axios.patch(`https://api.aurora.center/api/post/${id}`, data, { headers })
    dispatch({
...
export const removePost = (id, accessToken) => async (dispatch) => {
  try {
    ...
    await axios.delete(`https://api.aurora.center/api/post/${id}`, { headers })
    dispatch({
...
export const addComment = (postId, data, accessToken) => async (dispatch) => {
  try {
    ...
    const response = await axios.post(`https://api.aurora.center/api/comment/${postId}`, data, { headers })
    dispatch({
...
export const updateComment = (postId, commentId, data, accessToken) => async (dispatch) => {
  try {
    ...
    await axios.patch(`https://api.aurora.center/api/comment/${commentId}`, data, { headers })
    dispatch({
...
export const removeComment = (postId, commentId, accessToken) => async (dispatch) => {
  try {
    ...
    await axios.delete(`https://api.aurora.center/api/post/${postId}/comment/${commentId}`, { headers })
    dispatch({
...
export const loadAllStatistics = () => async (dispatch) => {
  try {
    ...
    const response = await axios.get('https://api.aurora.center/api/all-moods')
    dispatch({
...
export const loadStatistics = (accessToken) => async (dispatch) => {
  try {
    ...
    const response = await axios.get('https://api.aurora.center/api/moods', { headers })
    dispatch({
...
export const loadLikePost = (accessToken) => async (dispatch) => {
  try {
    ...
    const response = await axios.get('https://api.aurora.center/api/like', { headers })
    dispatch({
...
export const likePost = (postId, accessToken) => async (dispatch) => {
  try {
    ...
    const response = await axios.post('https://api.aurora.center/api/like', data, { headers })
    dispatch({
...
export const unlikePost = (postId, accessToken) => async (dispatch) => {
  try {
    ...
    const response = await axios.delete('https://api.aurora.center/api/like', { headers, data })
    dispatch({
