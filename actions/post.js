...
export const firstLoadAllPost = (time, accessToken) => async (dispatch) => {
  try {
    ...
    const response = await axios.get(`http://ec2-3-36-58-211.ap-northeast-2.compute.amazonaws.com:5000/api/posts/all?page=${1}&createdAt=${time}`, { headers })
    dispatch({
...
export const moreLoadAllPost = (page, time, accessToken) => async (dispatch) => {
  try {
    ...
    const response = await axios.get(`http://ec2-3-36-58-211.ap-northeast-2.compute.amazonaws.com:5000/api/posts/all?page=${page}&createdAt=${time}`, { headers })
    dispatch({
...
export const firstLoadPost = (accessToken) => async (dispatch) => {
  try {
    ...
    const response = await axios.get(`http://ec2-3-36-58-211.ap-northeast-2.compute.amazonaws.com:5000/api/posts?page=${1}`, { headers })
    dispatch({
...
export const moreLoadPost = (page, accessToken) => async (dispatch) => {
  try {
    ...
    const response = await axios.get(`http://ec2-3-36-58-211.ap-northeast-2.compute.amazonaws.com:5000/api/posts?page=${page}`, { headers })
    dispatch({
...
export const addPost = (data, accessToken) => async (dispatch) => {
  try {
    ...
    const response = await axios.post('http://ec2-3-36-58-211.ap-northeast-2.compute.amazonaws.com:5000/api/post/', data, { headers })
    dispatch({
...
export const updatePost = (id, data, accessToken) => async (dispatch) => {
  try {
    ...
    const response = await axios.patch(`http://ec2-3-36-58-211.ap-northeast-2.compute.amazonaws.com:5000/api/post/${id}`, data, { headers })
    dispatch({
...
export const removePost = (id, accessToken) => async (dispatch) => {
  try {
    ...
    await axios.delete(`http://ec2-3-36-58-211.ap-northeast-2.compute.amazonaws.com:5000/api/post/${id}`, { headers })
    dispatch({
...
export const addComment = (postId, data, accessToken) => async (dispatch) => {
  try {
    ...
    const response = await axios.post(`http://ec2-3-36-58-211.ap-northeast-2.compute.amazonaws.com:5000/api/comment/${postId}`, data, { headers })
    dispatch({
...
export const updateComment = (postId, commentId, data, accessToken) => async (dispatch) => {
  try {
    ...
    await axios.patch(`http://ec2-3-36-58-211.ap-northeast-2.compute.amazonaws.com:5000/api/comment/${commentId}`, data, { headers })
    dispatch({
...
export const removeComment = (postId, commentId, accessToken) => async (dispatch) => {
  try {
    ...
    await axios.delete(`http://ec2-3-36-58-211.ap-northeast-2.compute.amazonaws.com:5000/api/post/${postId}/comment/${commentId}`, { headers })
    dispatch({
...
export const loadAllStatistics = () => async (dispatch) => {
  try {
    ...
    const response = await axios.get('http://ec2-3-36-58-211.ap-northeast-2.compute.amazonaws.com:5000/api/all-moods')
    dispatch({
...
export const loadStatistics = (accessToken) => async (dispatch) => {
  try {
    ...
    const response = await axios.get('http://ec2-3-36-58-211.ap-northeast-2.compute.amazonaws.com:5000/api/moods', { headers })
    dispatch({
...
export const loadLikePost = (accessToken) => async (dispatch) => {
  try {
    ...
    const response = await axios.get('http://ec2-3-36-58-211.ap-northeast-2.compute.amazonaws.com:5000/api/like', { headers })
    dispatch({
...
export const likePost = (postId, accessToken) => async (dispatch) => {
  try {
    ...
    const response = await axios.post('http://ec2-3-36-58-211.ap-northeast-2.compute.amazonaws.com:5000/api/like', data, { headers })
    dispatch({
...
export const unlikePost = (postId, accessToken) => async (dispatch) => {
  try {
    ...
    const response = await axios.delete('http://ec2-3-36-58-211.ap-northeast-2.compute.amazonaws.com:5000/api/like', { headers, data })
    dispatch({
